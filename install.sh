...
install_XrayR() {
    ...
    file="https://${GITHUB_URL}/zhoudedi/XrayR-release/raw/master/XrayR.service"
    ...
    if [[ ! -f /etc/XrayR/config.yml ]]; then
        ...
        if [[ $? == 0 ]]; then
            ...
            echo -e "${red}XrayR 可能启动失败，请稍后使用 XrayR log 查看日志信息，若无法启动，则可能更改了配置格式，请前往 wiki 查看：https://github.com/zhoudedi/XrayR/wiki${plain}"
        fi
    fi
