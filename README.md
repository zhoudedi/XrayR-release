...
Find the source code here: [Huac233/XrayR](https://github.com/Huac233/XrayR)

# 详细使用教程

[教程](https://crackair.gitbook.io/Huac233/)
...
```
1. `git clone https://github.com/Huac233/XrayR-release`
2. `cd XrayR-release`
3. 编辑config。
